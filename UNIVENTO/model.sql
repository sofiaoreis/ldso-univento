...
ALTER TABLE Coment ADD CONSTRAINT FK_Coment_Event 
	FOREIGN KEY (eventID) REFERENCES Event (eventID);

ALTER TABLE Coment ADD CONSTRAINT FK_Coment_Normal 
	FOREIGN KEY (normalID) REFERENCES Normal (normalID);

ALTER TABLE Date ADD CONSTRAINT FK_Date_Event 
	FOREIGN KEY (eventID) REFERENCES Event (eventID);

ALTER TABLE Date ADD CONSTRAINT FK_Date_Local 
